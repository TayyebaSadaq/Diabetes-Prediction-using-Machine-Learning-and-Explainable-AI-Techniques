...
### CREATING CLASSIFIERS FOR MODELS - with scaling where needed
...
for each in models:
    ...
    # sample prediction - first row of test data
    X_test = pd.DataFrame(X_test) # Keep as DataFrame to match model input format
